...
transfer_type = "value_network_transfer" # "all", "policy_network_transfer", "value_network_transfer",  "shared_feature_extractor"
#pretrained model path
'''
Pretrained model path
'''
pretrained_model_path = "../3.2-a2c-pong/a2c_model_PongNoFrameskip-v4.zip"
unzip_pretrained_path = "./pretrained/a2c_model_PongNoFrameskip-v4_unzipped"
...
name_train = f"a2c_{env_id}_train-{transfer_type}"
name_test = f"a2c_{env_id}_test-{transfer_type}"
