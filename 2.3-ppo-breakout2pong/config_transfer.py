...
transfer_type = "policy_value_network_transfer" # "all" # "all", "policy_network_transfer", "value_network_transfer",  "shared_feature_extractor"

#pretrained model path
'''
Pretrained model path
'''
pretrained_model_path = "./pretrained/PPO_BreakoutNoFrameskip-v4_False2"
unzip_pretrained_path = "./pretrained/PPO_BreakoutNoFrameskip-v4_False2_unzipped"
